...
function updateSkinTexture(imageData, imagePath)
    ...
    setTexture(head, skinImage, "normal")
    setTexture(torso, skinImage, "normal")
    setTexture(right_arm, skinImage, "normal_slim")
    setTexture(left_arm, skinImage, "normal_slim")
    setTexture(right_arm, skinImage, "normal_wide")
    setTexture(left_arm, skinImage, "normal_wide")
    setTexture(left_leg, skinImage, "normal")
    setTexture(right_leg, skinImage, "normal")
end
